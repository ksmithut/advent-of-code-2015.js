 ...
 * to reduce the chance of any <span title="Santa does not elaborate on what he
 * means by this, but the cringe he makes indicates that it wouldn't be
 * pretty.">"complications"</span>. The quantum entanglement of a group of
 * packages is the
 * [product](https://en.wikipedia.org/wiki/Product_%28mathematics%29) of their
 * weights, that is, the value you get when you multiply their weights
 * together. Only consider quantum entanglement if the first group has the
 * fewest possible number of packages in it and all groups weigh the same
 * amount.
 *
