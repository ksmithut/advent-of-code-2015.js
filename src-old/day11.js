...
const hasTwoPairs = val =>
  (val.match(/(\w)\1/g) || []).filter((pair, i, arr) => arr.indexOf(pair) === i)
    .length >= 2

const validPassword = passAll([hasStraight, hasValidChars, hasTwoPairs])
