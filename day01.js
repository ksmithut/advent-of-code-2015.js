 ...
 * when you complete the first. Each puzzle grants one star. <span title="Also,
 * some puzzles contain Easter eggs like this one. Yes, I know it's not
 * traditional to do advent calendars for Easter.">Good luck!</span>
 *
...
function part2(input) {
  let floor = 0
  return input.split('').findIndex((instruction) => {
